...
config: Dict[str, Any] = {
    ...
    "evict_frequency": 2.0,  # how often to run eviction function
    "evict_threshold": 5,  # the number of times a specimen is seen before eviction
    "max_evict": 5,  # how many specimens to evict at a time
